...
import com.practice.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
	...
	// declare the bean of OAuth2AuthorizeClient manager
	@Bean
	public OAuth2AuthorizedClientManager manager(ClientRegistrationRepository clientRegistrationRepository,
			OAuth2AuthorizedClientRepository aut2h2AuthorizedClientRepository) {
		...
		DefaultOAuth2AuthorizedClientManager defaultOAuth2AuthorizedClientManager = new DefaultOAuth2AuthorizedClientManager(
				clientRegistrationRepository, aut2h2AuthorizedClientRepository);
